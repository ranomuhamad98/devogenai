...
$(document).ready(function () {
  ...
  $(".customizer-color li").on("click", function () {
    ...
    $("#color").attr(
      "href",
      "/devogenai/genaiapp/static/assets/css/" + color + ".css"
    );
    ...
    function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/devogenai/genaiapp/static/assets/images/logo/logo.png");
